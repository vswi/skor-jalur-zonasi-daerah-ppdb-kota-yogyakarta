...
<script>
    ...
    this.page.url = 'https://skor-ppdb-sleman.lovable.app/';  // Replace PAGE_URL with your page's canonical URL variable
    this.page.identifier = 'ppdbsleman'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
    };
    
    (function() { // DON'T EDIT BELOW THIS LINE
    var d = document, s = d.createElement('script');
    s.src = 'https://ppdbsleman.disqus.com/embed.js';
